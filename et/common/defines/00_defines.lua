...
NDiplomacy = {
	...
	GUARANTEE_COST = 20,							-- Scale with the number of already guaranteed countries.
...
NCountry = {
	...
	STARTING_COMMAND_POWER = 45.0,					-- starting command power for every country
	BASE_MAX_COMMAND_POWER = 999.0,					-- base value for maximum command power
	...
	DAYS_OF_WAR_BEFORE_SURRENDER = 2,				-- Number of days a war has to have existed before anyone can surrender in it
...
NBuildings = {
	...
	MAX_BUILDING_LEVELS = 35,			-- Max levels a building can have.
	...
	ROCKETSITE_CAPACITY_MULT = 1000,		-- Each level of rocketsite building multiplied by this, gives capacity (max operational value). Value is int. 1 for each rocket.
...
NMilitary = {
	...
	FIELD_MARSHAL_DIVISIONS_CAP = 120,			-- how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	NUKE_DELAY_HOURS = 0,							-- How many hours does it take for the nuclear drop to happen
